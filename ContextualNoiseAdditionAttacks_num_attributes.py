...
for index, row in df.iterrows():
    ...
    modified_note_prompt= "'"+orig_note+"'.For this clinical note please elaborate some additional information such as  some personal attributes of the person such educational background,job,achievemnets,\
